        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                  <h3 class="card-title ">Spot Trading History</h3>
                  <div class="card-tools d-sm-flex mt-1 d-block">
                    ...
                    <form class="form-inline ml-0 ml-sm-3 my-auto  " action="" method="get"  > --}}
                        <div class="input-group input-group-sm  mt-3 mt-sm-0 ml-lg-3">
                            <input class="form-control" type="date" placeholder="Search" name="date" value="{{ Request()->date }}" max="{{ date('Y-m-d')}}" onchange="$('#select_type').submit();">
                        </div>
                        ...
                        <div class="mt-3   ml-lg-3 mt-sm-2 ">
                        ...
                        <div class="mt-3 mt-sm-2 ml-3 ml-sm-3 ">
                            ...
                            <a class="btn btn-danger ml-3 btn-sm" href="{{ route('admin.spot_trading_history' , ['status' => 0]) }}">Reset </a>
                        </div>
                    </form>
                </div>
                </div>
                ...
                <div class="card-body p-0">
                  ...
                  <table class="table ">
                    ...
                    <tbody>
                        ...
                        @if(count($spot_history) > 0)
                        @foreach ($spot_history as $key=>$trade)
                        <tr>
                            <td>{{$spot_history->firstItem()+$key}}</td>
