        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Send USDT Balance</h4>
                ...
                <div class="card-body p-0">
                    <div class="card-body">
                        <form role="form" method="post" action="{{route('admin.postEpin',$user->id)}}">
                            @csrf
                          <div class="col-md-6">
                              <!-- text input -->
                              <div class="form-group">
                                <label >User</label>
                                <input type="text" class="form-control" value="{{ $user->name }}({{ $user->uid }})" readonly disabled>
                              </div>
                              <div class="form-group">
                                <label>Amount</label>
