<template>
      ...
      <div class="container mt-5 text-dark pt-5">
                  ...
                  <form class=" d-block d-sm-flex justify-content-end ml-0 ml-sm-3   " action="" method="get"  >
                   ...
                   <div class="ml-sm-3 mt-2 mt-sm-0 d-flex gap-3">
                       <!-- <button class=" text-success btn-sm "  @click="withdraw_history"> Search </button> -->
                       <a href="#" class="page-link  text-white ms-0 ms-sm-3 search_input bg-success" @click="withdraw_history">Search</a>
                       <!-- <router-link :to="{ name : 'withdraw_history'}" class=" ml-3 btn-sm text-danger btn-sm">Reset </router-link> -->
  ...
  export default {
      ...
      methods:{
         ...
         withdraw_history(){
          // axios.post(this.apiUrl+"api/withdraw_history",{
          axios.post(this.apiUrl+ "api/withdraws?page=" + this.page,{
            ...
            console.log("res "+res);
              ...
              this.last_page = res.data.withdraw.last_page;
          }).catch(err=>{
              console.log(err);
          });
         },
